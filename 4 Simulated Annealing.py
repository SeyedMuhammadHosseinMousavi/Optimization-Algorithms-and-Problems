...
def simulated_annealing(func, bounds, initial_temp=1000, cooling_rate=0.95, max_iterations=1000):
    ...
    for iteration in range(max_iterations):
        ...
        new_solution = current_solution + np.random.uniform(-0.1, 0.1, dimensions)
...
# Run Simulated Annealing and visualize results
...
for idx, (name, func, bounds) in enumerate(functions):
    ...
    best_x, costs = simulated_annealing(func, bounds, initial_temp=1000, cooling_rate=0.95, max_iterations=1000)
    ...
    complexity_category = map_complexity_category(algorithm, 10, 1000)  # Example with neighborhood_size=10, max_iterations=1000
